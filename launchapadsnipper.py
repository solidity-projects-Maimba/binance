...
# current tokenaddress ::0x317eb4ad9cfac6232f0046831322e895507bcbeb
#  source binance/bin/activate
# python "/home/debian/vscode/launchpads/launchpad-sniper/launchapadsnipper.py"
...
factoryMainnet = web3.toChecksumAddress('0xca143ce32fe78f1f7019d7d551a6402fc5350c73')    #0x6725F303b657a9451d8BA641348b6761A6CC7a17         0xb7926c0430afb07aa7defde6da862ae0bde767bc
#factory contractmainnet=0xca143ce32fe78f1f7019d7d551a6402fc5350c73 
...
#router contractmainnet=0x10ED43C718714eb63d5aA57B78B54704E256024E
                        #testnet=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
#Token WBNB Main & Testnet 

wbnbTestnet = web3.toChecksumAddress('0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')
#wbnbtestnet = 0xae13d989dac2f0debff460ac112a837c89baa7cd
#busdTestnet = web3.toChecksumAddress('0x78867bbeef44f2326bf8ddd1941a4439382ef2a7')
#busdmainnet = 0xe9e7cea3dedca5984780bafc599bd69add087d56
#wbnbmainnet = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
#usdtmainnet= 0x55d398326f99059ff775485246999027b3197955

#UserAddress to buy token with
sender_address = web3.toChecksumAddress(config.address )

#Token to buy 
tokenA = web3.toChecksumAddress(input('Address of token to be snipped; '))  #TokenAddress of token to snipe
tokenB = wbnbTestnet #Token Address to buy token with wbnb or wbusd 

#Token to spend  select mainnet or testnet  or wbusd
spend = wbnbTestnet  
...
uniswap_factory = factoryMainnet  
...
#select mainnet or testnet
panRouterContractAddress = routerMainnet
...
# 4)If conditions are met we buy the token
def buy():
    print('we start the snipe')
    ...
    pancakeswap2_txn = contractbuy.functions.swapExactETHForTokensSupportingFeeOnTransferTokens(
    ...
    'from': sender_address,
    'value': web3.toWei(0.08,'ether'),#This is the Token(BNB) amount you want to Swap from  | Comment out for token
    'gas':210000,
...
#3)Check liquidity balance

def checkLp():
    print('cehck for balance')
    lp = pair
